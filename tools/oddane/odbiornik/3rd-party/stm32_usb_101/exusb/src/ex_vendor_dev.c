...
static usb_string_descriptor_t(42) const string_product = {
  sizeof(usb_string_descriptor_t(42)),
  STRING_DESCRIPTOR,
  {
    HTOUSBS('U'), HTOUSBS('S'), HTOUSBS('B'), HTOUSBS(' '),
    HTOUSBS('s'), HTOUSBS('e'), HTOUSBS('l'), HTOUSBS('f'),
    HTOUSBS(' '), HTOUSBS('p'), HTOUSBS('o'), HTOUSBS('w'),
    HTOUSBS('e'), HTOUSBS('r'), HTOUSBS('e'), HTOUSBS('d'),
...
static usbd_callback_list_t const ApplicationCallBacks = {
  ...
  GetStatus, 0, 0, 0, 0, VendorNoDataSetup,
