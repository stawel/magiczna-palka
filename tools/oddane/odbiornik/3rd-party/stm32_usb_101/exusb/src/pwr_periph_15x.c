...
#define RCC_POWER_LED   xcat(RCC_AHBPeriph_GPIO, POWER_LED_GPIO_N)
...
#define RCC_PUSH_BUTTON         xcat(RCC_AHBPeriph_GPIO, PUSH_BUTTON_GPIO_N)
...
void PowerLEDconfigure() {
  ...
  RCC_AHBPeriphClockCmd(RCC_POWER_LED, ENABLE);
...
void WakeupButtonConfigure() {
  ...
  RCC_AHBPeriphClockCmd(RCC_PUSH_BUTTON, ENABLE);
