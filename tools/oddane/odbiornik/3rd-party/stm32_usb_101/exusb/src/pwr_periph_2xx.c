...
#define RCC_POWER_LED   xcat(RCC_AHB1Periph_GPIO, POWER_LED_GPIO_N)
...
#define RCC_PUSH_BUTTON         xcat(RCC_AHB1Periph_GPIO, PUSH_BUTTON_GPIO_N)
#define PORT_SRC_PUSH_BUTTON    xcat(EXTI_PortSourceGPIO, PUSH_BUTTON_GPIO_N)
#define PIN_SRC_PUSH_BUTTON     xcat(EXTI_PinSource, PUSH_BUTTON_PIN_N)
...
void PowerLEDconfigure() {
  ...
  RCC_AHB1PeriphClockCmd(RCC_POWER_LED, ENABLE);
...
void WakeupButtonConfigure() {
  ...
  RCC_AHB1PeriphClockCmd(RCC_PUSH_BUTTON, ENABLE);
  ...
  SYSCFG_EXTILineConfig(PORT_SRC_PUSH_BUTTON, PIN_SRC_PUSH_BUTTON);
