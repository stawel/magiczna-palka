...
def calculate_pos(idx, diff):
    ...
    x, y, cut_pos_min, cut_x, cut_y = mp3d.signal.get_data_first_max(idx, len(szuk_org), diff);
...
def update_line(num):
    ...
    t_data = 0.
    x,y, wyn1,t1 = calculate_pos(0,0)
    l1.set_data(x,y)
    lp1.set_data([wyn1,wyn1],[0,256])

    x,y, wyn2,t2 = calculate_pos(1,-50)
    l2.set_data(x,y)
    lp2.set_data([wyn2,wyn2],[0,256])

    x,y, wyn3,t3 = calculate_pos(2,-100)
    l3.set_data(x,y)
