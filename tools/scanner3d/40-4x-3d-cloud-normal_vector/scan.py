...
def update_dot(num):
    ...
    v0 = v3d_sqrt(mp3d.xyz.best_3d_match_info[0])/1.5
    v1 = (posNx[0]-posNx[1])/2;
    v2 = (posNx[1]-posNx[2])/2;

    print 'v0:', v0, ' v1:', v1, ' v2:', v2
    print '|v0|=', v3d_length(v0), ' |v1|=', v3d_length(v1), ' |v2|=', v3d_length(v2)
    setVector(1, pos_cur, pos_cur + v0)
    setVector(0, pos_cur, pos_cur + v1)
    setVector(2, pos_cur, pos_cur + v2)
    fig3.canvas.draw()
