...
analogowo-cyfrowe umożliwiające samplowanie z prędkością dochodzącą do \SI{2,4}{MSPS}, które wykorzystane zostały do próbkowania
...
Częstotliwość pracy przetworników ustawiona jest na \SI{1,6}{MSPS} co daje średnio 40 sampli na jedną sinusoidę nadanego \SI{40}{kHz} sygnału.
