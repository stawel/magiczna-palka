...
\addcontentsline{toc}{chapter}{Bibliografia}
  ...
  \bibitem{bib:soundSpeed}  Dean E. A., \textit{Atmospheric Effects on the Speed of Sound}, BATTELLE COLUMBUS LABS DURHAM NC, sierpień 1979
  ...
  \textit{Power Glove}, wikipedia
  \myurl{https://en.wikipedia.org/wiki/Power_Glove}

  \bibitem{bib:powerGlove2}
  \textit{Reach Out And Touch Your Data}, BYTE JULY 1990, IBM
