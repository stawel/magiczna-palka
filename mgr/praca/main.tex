...
\title{Wyznaczanie pozycji oraz orientacji w przestrzeni za pomocą ultradźwięków, skaner 3D}
\tytulang{Determining position and orientation in space using ultrasound, 3D scanner}
