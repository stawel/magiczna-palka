...
\item \label{itm:second_method}
 ...
 Wady to: są stosunkowo niska rozdzielczość, szczególnie w osi Z, i duży strumień danych do obróbki.
...
\item
 ...
 generowanego przez zewnętrzne anteny. Na podstawie siły pola docierającego do badanego obiektu estymowana jest jego odległość 
 ...
 to na lokalizowanie obiekty również pod ziemią, co zaprezentowano w pacy
...
odległości jest dużo bardziej podatny na błędy. Ponadto autorzy koncentrują się jedynie
